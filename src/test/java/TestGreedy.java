...
public class TestGreedy {
    ...
    public void optimalSolutions(){
        ...
        level = new Level(new Rucksack(6),items,amount,0);
        ...
        Assertions.assertEquals(s.sortLikeGreedy(expected),s.solveGreedy(level));
        // None Fit
        items = new ArrayList<>();
        expected = new ArrayList<>();
        ...
        level = new Level(new Rucksack(50),items,amount,0);
        expected.add(items.get(2));
        expected.add(items.get(1));
    ...
    public void Epic3(){
        ...
        level = new Level(new Rucksack(10),items,amount,0);
        expected.add(items.get(0));
        expected.add(items.get(1));
    ...
    public void Epic1(){
        ...
        level = new Level(new Rucksack(5),items,amount,0);
        expected.add(items.get(0));
    ...
    public void badInputs(){
        ...
        items.add(new Item(130,20,"2"));
        items.add(new Item(200,30,"3"));
        level = new Level(new Rucksack(0),items,amount,0);
        ...
        level = new Level(new Rucksack(80),items,amount,0);
        expected.add(items.get(0));
        expected.add(items.get(1));
        expected.add(items.get(2));
